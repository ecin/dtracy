...
dtracy.Event.prototype.toString = function(){
  ...
  string += "<span class='evnt_argument_name'>pid</span> ";
  string += "<span class='evnt_argument_value'>" + this.pid + "</span> ";
  
  for( key in this.arguments ){
    string += "<span class='evnt_argument_name'>" + key + "</span> ";
    string += "<span class='evnt_argument_value'>" + this.arguments[key] + "</span> ";
  }
